...
data_arg.add_argument('--train_dir', type=list, default=[
                                                        'data/simdial/train/restaurant-MixSpec-2000.json',
                                                         'data/simdial/train/movie-MixSpec-2000.json',
                                                         ])
data_arg.add_argument('--test_dir', type=list, default=[
...
def main(config):
    ...
    valid_feed = SimDialDataLoader("Valid", valid_dial, domain_meta, config,warmup_data)
    test_feed = SimDialDataLoader("Test", test_dial, domain_meta, config,warmup_data)
